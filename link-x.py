...
Note:
    ...
    Pushy will not be responsible for any Misuse
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Pushy and Toxic-Noob Inc.                \033[94m│".center(columns+14))
    print("│ \033[95mTool   : Hack With Link                \033[94m│".center(columns+8))
    print("│ \033[95mGitHub : https://github.com/dhritzz    \033[94m│".center(columns+8))
    print("│ \033[95mCoder  : Dhany                   \033[37mV2.0  \033[94m│".center(columns+14))
    print("\033[94m└────────────────────────────────────────┘".center(columns+4))
...
def update():
    ...
    try:
        ...
        oldVersion = "pushy and toxic noobInc."
    ...
    if not (oldVersion == newVersion):
        ...
        os.system("cd ../ && rm -rf Link-X && git clone https://github.com/dhritzz/segs > /dev/null 2>&1")
        psb("\n    [cGreen*cWhite] Update Complete!")
        psb("    [cGreen*cWhite] Starting new Version...")
        os.system("cd ../Link-X && python segs.py")
    else:
